...
export const mapData: Record<string, CityMapData> = {
  ...
  "brasil-volta": {
    ...
    zoom: 5,
    pois: [
      { id: "gru-chegada", label: "Aeroporto de Guarulhos (GRU)", lat: -23.4356, lng: -46.4731, day: 23, time: "Noite", description: "Chegada do voo internacional MAD → GRU" },
      { id: "bsb-chegada", label: "Aeroporto de Brasília (BSB)", lat: -15.8711, lng: -47.9186, day: 23, time: "Noite", description: "Último trecho! Chegada em casa!" },
    ],
    trainRoutes: [
      {
        fromId: "gru-chegada",
  ...
  madrid: {
    ...
    pois: [
      { id: "mad-barajas", label: "Aeroporto Barajas", lat: 40.4719, lng: -3.5626, day: 3, time: "Manhã", description: "Pouso 10:45 — imigração + bagagem" },
  ...
  paris: {
    ...
    pois: [
      { id: "par-trocadero", label: "Trocadéro", lat: 48.8616, lng: 2.2886, day: 5, time: "Manhã", description: "Foto clássica com Torre Eiffel" },
      { id: "par-orsay", label: "Musée d'Orsay", lat: 48.8600, lng: 2.3266, day: 5, time: "Tarde", description: "Monet, Renoir, Van Gogh — ~16 EUR" },
      { id: "par-cruzeiro", label: "Cruzeiro pelo Sena", lat: 48.8584, lng: 2.2945, day: 5, time: "Noite", description: "Pôr do sol no rio" },
      { id: "par-louvre", label: "Louvre", lat: 48.8606, lng: 2.3376, day: 6, time: "Manhã", description: "Mona Lisa, Vênus de Milo — ~22 EUR" },
      { id: "par-disney", label: "Disneyland Paris", lat: 48.8674, lng: 2.7836, day: 6, time: "Tarde/Noite", description: "RER A ~40 min — show noturno!" },
      { id: "par-notre-dame", label: "Notre-Dame", lat: 48.8530, lng: 2.3499, day: 7, time: "Manhã", description: "Restaurada! Ingresso gratuito com reserva" },
      ...
      { id: "par-arc", label: "Arco do Triunfo", lat: 48.8738, lng: 2.2950, day: 7, time: "Tarde", description: "Vista 360° — ~13 EUR" },
    ],
    accommodations: [
      {
        id: "acc-paris",
  ...
  italia: {
    ...
    pois: [
      ...
      // Florença (Days 11-13)
      { id: "ita-signoria", label: "Piazza della Signoria", lat: 43.7696, lng: 11.2558, day: 13, time: "Tarde", description: "Palazzo Vecchio" },
      { id: "ita-ponte-vecchio", label: "Ponte Vecchio", lat: 43.7680, lng: 11.2531, day: 13, time: "Tarde", description: "Ponte medieval com joalherias" },
      { id: "ita-uffizi", label: "Uffizi", lat: 43.7677, lng: 11.2553, day: 14, time: "Manhã", description: "Botticelli, Leonardo, Michelangelo — 3h" },
      { id: "ita-brunelleschi", label: "Cúpula de Brunelleschi", lat: 43.7731, lng: 11.2560, day: 14, time: "Tarde", description: "463 degraus — vista 360°" },
      { id: "ita-piazzale", label: "Piazzale Michelangelo", lat: 43.7629, lng: 11.2650, day: 14, time: "Noite", description: "Pôr do sol sobre Florença" },
      ...
      // Roma (Days 13-15)
      { id: "ita-trevi", label: "Fontana di Trevi", lat: 41.9009, lng: 12.4833, day: 15, time: "Noite", description: "Iluminada à noite" },
      { id: "ita-spagna", label: "Piazza di Spagna", lat: 41.9057, lng: 12.4823, day: 15, time: "Noite", description: "Escadaria" },
      { id: "ita-coliseu", label: "Coliseu", lat: 41.8902, lng: 12.4922, day: 16, time: "Manhã", description: "Foro Romano + Palatino — 18 EUR" },
      ...
      { id: "ita-trastevere", label: "Trastevere", lat: 41.8893, lng: 12.4695, day: 16, time: "Noite", description: "Cacio e pepe, carbonara" },
      { id: "ita-vaticano", label: "Vaticano + Sistina", lat: 41.9029, lng: 12.4534, day: 17, time: "Manhã", description: "Chegue 8h — 17 EUR" },
      { id: "ita-santangelo", label: "Castel Sant'Angelo", lat: 41.9031, lng: 12.4663, day: 17, time: "Tarde", description: "Vista do Tibre" },
    ],
    accommodations: [
      {
        id: "acc-milao",
  ...
  londres: {
    ...
    pois: [
      { id: "lon-westminster", label: "Big Ben / Westminster", lat: 51.5007, lng: -0.1246, day: 18, time: "Manhã", description: "Parlamento" },
      { id: "lon-abbey", label: "Abadia de Westminster", lat: 51.4993, lng: -0.1273, day: 18, time: "Manhã", description: "29 GBP/pessoa" },
      { id: "lon-eye", label: "London Eye", lat: 51.5033, lng: -0.1195, day: 18, time: "Tarde", description: "30-37 GBP/pessoa" },
      { id: "lon-tate", label: "Tate Modern", lat: 51.5076, lng: -0.0994, day: 18, time: "Tarde", description: "Grátis!" },
      { id: "lon-stpauls", label: "St Paul's Cathedral", lat: 51.5138, lng: -0.0984, day: 18, time: "Tarde", description: "Catedral icônica" },
      { id: "lon-borough", label: "Borough Market", lat: 51.5055, lng: -0.0910, day: 18, time: "Noite", description: "Fish & chips + pub" },
      { id: "lon-buckingham", label: "Buckingham Palace", lat: 51.5014, lng: -0.1419, day: 19, time: "Manhã", description: "Troca da guarda" },
      { id: "lon-hyde", label: "Hyde Park", lat: 51.5073, lng: -0.1657, day: 19, time: "Manhã", description: "Passeio" },
      { id: "lon-british", label: "British Museum", lat: 51.5194, lng: -0.1270, day: 19, time: "Tarde", description: "Grátis!" },
      { id: "lon-natural", label: "Natural History Museum", lat: 51.4966, lng: -0.1764, day: 19, time: "Tarde", description: "Grátis!" },
      { id: "lon-covent", label: "Covent Garden", lat: 51.5117, lng: -0.1240, day: 19, time: "Noite", description: "West End Musical" },
      ...
      { id: "lon-shoreditch", label: "Shoreditch / Brick Lane", lat: 51.5235, lng: -0.0711, day: 20, time: "Tarde", description: "Street art e mercados" },
      { id: "lon-camden", label: "Camden Town", lat: 51.5392, lng: -0.1426, day: 20, time: "Noite", description: "Alternativo e vibrante" },
      { id: "lon-sky-garden", label: "Sky Garden", lat: 51.5114, lng: -0.0836, day: 21, time: "Manhã", description: "Vista grátis!" },
      { id: "lon-oxford", label: "Oxford Street", lat: 51.5145, lng: -0.1445, day: 21, time: "Tarde", description: "Compras + afternoon tea" },
    ],
    accommodations: [
      {
        id: "acc-londres",
  ...
  "madrid-volta": {
    ...
    pois: [
      { id: "madv-colon", label: "Plaza de Colón", lat: 40.4251, lng: -3.6903, day: 22, time: "Manhã", description: "Feriado! Desfile Día de la Hispanidad" },
      { id: "madv-malasana", label: "Malasaña", lat: 40.4266, lng: -3.7050, day: 22, time: "Manhã", description: "Brunch e café" },
      { id: "madv-corte-ingles", label: "El Corte Inglés (Sol)", lat: 40.4178, lng: -3.7035, day: 22, time: "Tarde", description: "Jamón, azeite, vinhos, lembrancinhas" },
      { id: "madv-tapas", label: "Tapas de Despedida", lat: 40.4130, lng: -3.7100, day: 22, time: "Noite", description: "Último jantar da Eurotrip!" },
      { id: "madv-barajas", label: "Aeroporto Barajas", lat: 40.4719, lng: -3.5626, day: 23, time: "Dia", description: "Voo MAD → GRU — Duty Free!" },
    ],
    accommodations: [
      {
        id: "acc-madrid-volta",
