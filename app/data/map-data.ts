...
export const mapData: Record<string, CityMapData> = {
  ...
  "brasil-volta": {
    ...
    zoom: 5,
    pois: [
      { id: "gru-chegada", label: "Aeroporto de Guarulhos (GRU)", lat: -23.4356, lng: -46.4731, day: 24, time: "Noite", description: "Chegada do voo internacional MAD → GRU" },
      { id: "bsb-chegada", label: "Aeroporto de Brasília (BSB)", lat: -15.8711, lng: -47.9186, day: 24, time: "Noite", description: "Último trecho! Chegada em casa!" },
    ],
    trainRoutes: [
      {
        fromId: "gru-chegada",
  ...
  madrid: {
    ...
    arrival: {
      ...
      details: "IB0268 Iberia Direto · 31.250 Avios/pessoa · Duração 11h25",
      waypoints: [
  ...
  paris: {
    ...
    pois: [
      { id: "par-trocadero", label: "Trocadéro", lat: 48.8616, lng: 2.2886, day: 6, time: "Manhã", description: "Foto clássica com Torre Eiffel" },
  ...
  londres: {
    ...
    pois: [
      { id: "lon-westminster", label: "Big Ben / Westminster", lat: 51.5007, lng: -0.1246, day: 19, time: "Manhã", description: "Parlamento" },
      { id: "lon-abbey", label: "Abadia de Westminster", lat: 51.4993, lng: -0.1273, day: 19, time: "Manhã", description: "29 GBP/pessoa" },
      { id: "lon-eye", label: "London Eye", lat: 51.5033, lng: -0.1195, day: 19, time: "Tarde", description: "30-37 GBP/pessoa" },
  ...
  "madrid-volta": {
    ...
    pois: [
      { id: "madv-colon", label: "Plaza de Colón", lat: 40.4251, lng: -3.6903, day: 23, time: "Manhã", description: "Passeio tranquilo — último dia na Europa" },
      { id: "madv-malasana", label: "Malasaña", lat: 40.4266, lng: -3.7050, day: 23, time: "Manhã", description: "Brunch e café" },
      { id: "madv-corte-ingles", label: "El Corte Inglés (Sol)", lat: 40.4178, lng: -3.7035, day: 23, time: "Tarde", description: "Jamón, azeite, vinhos, lembrancinhas" },
      { id: "madv-tapas", label: "Tapas de Despedida", lat: 40.4130, lng: -3.7100, day: 23, time: "Noite", description: "Último jantar da Eurotrip!" },
      { id: "madv-barajas", label: "Aeroporto Barajas", lat: 40.4719, lng: -3.5626, day: 24, time: "Dia", description: "Voo MAD → GRU — Duty Free!" },
    ],
    accommodations: [
      {
        id: "acc-madrid-volta",
